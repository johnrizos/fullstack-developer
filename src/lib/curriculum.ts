...
export const curriculum: CurriculumSection[] = [
  ...
  },
  {
    ...
    title: "Mobile",
    description:
      "Χτίζεις πραγματικά native mobile apps — cross-platform με React Native (αξιοποιώντας τη React γνώση σου) και native Android με Kotlin & Jetpack Compose, το επίσημο Kotlin-first stack της Google.",
    lessons: [
      {
        id: "react-native",
        title: "React Native",
