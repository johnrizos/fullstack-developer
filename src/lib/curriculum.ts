...
export const curriculum: CurriculumSection[] = [
  ...
  },
  {
    ...
    description:
      "Αξιοποιείς τη React γνώση σου για να χτίσεις πραγματικά native iOS/Android apps: core components, Flexbox layout, navigation, λίστες & performance, native APIs, offline data και shipping στα stores.",
    lessons: [
      {
        id: "react-native",
        title: "React Native",
